...
class RobotController:
    ...
    def compute_joint_angles(self, target_position):
        ...
        print("target position shape: ", target_position.shape)
        ...
        target_joints = IK(self.model, init_joints, target_position, orientation=False)
